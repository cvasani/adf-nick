...
// ---------------------------------------------------------------------
public class EmployeesImpl extends ExtEntityImpl {
    /**
    ...
    protected enum AttributesEnum {
        ...
        protected int index() {
            return EmployeesImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        protected static int count() {
            return EmployeesImpl.AttributesEnum.firstIndex() + EmployeesImpl.AttributesEnum
                                                                            .staticValues().length;
        }

        protected static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = EmployeesImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
