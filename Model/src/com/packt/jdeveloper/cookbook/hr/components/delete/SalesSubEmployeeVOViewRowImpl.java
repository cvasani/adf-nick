...
// ---------------------------------------------------------------------
public class SalesSubEmployeeVOViewRowImpl extends ViewRowImpl {
    public static final int ENTITY_SALESSUBEMPLOYEEEO = 0;
     ...
     */
    public SalesSubEmployeeVOViewRowImpl() {
    }

    /**
     * Gets SalesSubEmployeeEO entity object.
     * @return the SalesSubEmployeeEO
     */
    public MarketingBaseEmployeeEOImpl getSalesSubEmployeeEO() {
        return (SalesSubEmployeeEOImpl) getEntity(ENTITY_SALESSUBEMPLOYEEEO);
    }
