...
import com.packt.jdeveloper.cookbook.hr.components.model.entities.inheritance.ExecutiveSubEmployeeEOImpl;
...
// ---------------------------------------------------------------------
public class ExecutiveSubEmployeeVOViewRowImpl extends ViewRowImpl {


    public static final int ENTITY_EXECUTIVESUBEMPLOYEEEO = 0;
     ...
     */
    public ExecutiveSubEmployeeVOViewRowImpl() {
    }

    /**
     * Gets ExecutiveSubEmployeeEO entity object.
     * @return the ExecutiveSubEmployeeEO
     */
    public MarketingBaseEmployeeEOImpl getExecutiveSubEmployeeEO() {
        return (ExecutiveSubEmployeeEOImpl) getEntity(ENTITY_EXECUTIVESUBEMPLOYEEEO);
    }
