...
public class EmployeeCountImpl extends ExtViewObjectImpl {
    ...
    public void prepareRowSetForQuery(ViewRowSetImpl viewRowSetImpl) {
        ...
        Number departmentId =
            ((Number)((ExtApplicationModuleImpl)this.getApplicationModule()).getCustomData(DEFAULT_DEPARTMENT_ID_KEY));
        viewRowSetImpl.setNamedWhereClauseParam("DepartmentId", departmentId);
//        viewRowSetImpl.ensureVariableManager().setVariableValue("DepartmentId", departmentId);
